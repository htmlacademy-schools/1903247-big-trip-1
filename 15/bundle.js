...
var _adaptToServer = /*#__PURE__*/new WeakMap();
...
class ApiService {
  constructor(endPoint, authorization) {
    ...
    _defineProperty(this, "updatePoint", async point => {
      const response = await _classPrivateFieldGet(this, _load).call(this, {
        url: `points/${point.id}`,
        method: Method.PUT,
        body: JSON.stringify(_classPrivateFieldGet(this, _adaptToServer).call(this, point)),
        headers: new Headers({
    ...
    _defineProperty(this, "addPoint", async point => {
      const response = await _classPrivateFieldGet(this, _load).call(this, {
        url: 'points',
        method: Method.POST,
        body: JSON.stringify(_classPrivateFieldGet(this, _adaptToServer).call(this, point)),
    ...
    _classPrivateFieldInitSpec(this, _load, {
      ...
      value: async ({
        ...
        headers.append('Authorization', _classPrivateFieldGet(this, _authorization));
        const response = await fetch(`${_classPrivateFieldGet(this, _endPoint)}/${url}`, {
          method,
          body,
          headers
        });
    ...
    _classPrivateFieldInitSpec(this, _adaptToServer, {
      writable: true,
      value: point => {
    ...
    _classPrivateFieldSet(this, _endPoint, endPoint);

    _classPrivateFieldSet(this, _authorization, authorization);
  }
...
_defineProperty(ApiService, "parseResponse", response => response.json());

_defineProperty(ApiService, "checkStatus", response => {
  if (!response.ok) {
    throw new Error(`${response.status}: ${response.statusText}`);
  }
});

_defineProperty(ApiService, "catchError", err => {
  throw err;
});
...
var _apiService = /*#__PURE__*/new WeakMap();

var _adaptToClient = /*#__PURE__*/new WeakMap();

class PointsModels extends _utils_abstract_observers__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor(apiService) {
    ...
    _classPrivateFieldInitSpec(this, _apiService, {
      writable: true,
      value: null
    });
    ...
    _defineProperty(this, "init", async () => {
      try {
        ...
        _classPrivateFieldSet(this, _points, points.map(_classPrivateFieldGet(this, _adaptToClient)));
      } catch (err) {
        _classPrivateFieldSet(this, _points, []);
      }

      this._notify(_const__WEBPACK_IMPORTED_MODULE_0__.UpdateType.INIT);
    });
    ...
    _defineProperty(this, "updatePoint", async (updateType, update) => {
      ...
      try {
        ...
        const updatePoint = _classPrivateFieldGet(this, _adaptToClient).call(this, response);
    ...
    _defineProperty(this, "addPoint", async (updateType, update) => {
      try {
        ...
        const newPoint = _classPrivateFieldGet(this, _adaptToClient).call(this, response);
    ...
    _defineProperty(this, "deletePoint", async (updateType, update) => {
      ...
      try {
        await _classPrivateFieldGet(this, _apiService).deletePoint(update);
    ...
    _classPrivateFieldInitSpec(this, _adaptToClient, {
      writable: true,
      value: point => {
        const adaptedPoint = { ...point,
    ...
    _classPrivateFieldSet(this, _apiService, apiService);
  }
...
class FilterPresenter {
  constructor(filterContainer, filterModel) {
    ...
    _defineProperty(this, "destroy", () => {
      (0,_render__WEBPACK_IMPORTED_MODULE_1__.remove)(_classPrivateFieldGet(this, _filterComponent));
      ...
      _classPrivateFieldGet(this, _filterModel).setFilter(_const__WEBPACK_IMPORTED_MODULE_2__.UpdateType.MAJOR, _const__WEBPACK_IMPORTED_MODULE_2__.FilterType.ALL);
    });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ PointNewPresenter)
/* harmony export */ });
/* harmony import */ var _view_offer_form_view__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../view/offer-form-view */ "./src/view/offer-form-view.js");
/* harmony import */ var _render__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../render */ "./src/render.js");
/* harmony import */ var _const__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../const */ "./src/const.js");
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var _destroyCallback = /*#__PURE__*/new WeakMap();
...
class PointNewPresenter {
  constructor(pointContainer, changeData) {
    ...
    _classPrivateFieldInitSpec(this, _destroyCallback, {
      writable: true,
      value: null
    });

    _defineProperty(this, "init", (newPoint, callback) => {
      _classPrivateFieldSet(this, _newPoint, newPoint);

      _classPrivateFieldSet(this, _destroyCallback, callback);

      if (_classPrivateFieldGet(this, _pointEditComponent) !== null) {
        return;
      }

      _classPrivateFieldSet(this, _pointEditComponent, new _view_offer_form_view__WEBPACK_IMPORTED_MODULE_0__["default"](_classPrivateFieldGet(this, _newPoint)));
    ...
    _defineProperty(this, "destroy", () => {
      ...
      (_classPrivateFieldGet2 = _classPrivateFieldGet(this, _destroyCallback)) === null || _classPrivateFieldGet2 === void 0 ? void 0 : _classPrivateFieldGet2.call(this);
    ...
    _defineProperty(this, "setSaving", () => {
      _classPrivateFieldGet(this, _pointEditComponent).updateData({
        isDisabled: true,
        isSaving: true
      });
    });
    ...
    _classPrivateFieldInitSpec(this, _handleFormSubmit, {
      writable: true,
      value: point => {
        _classPrivateFieldGet(this, _changeData).call(this, _const__WEBPACK_IMPORTED_MODULE_2__.UserAction.ADD_POINT, _const__WEBPACK_IMPORTED_MODULE_2__.UpdateType.MINOR, point); //this.destroy();
...
var _onArrowClick = /*#__PURE__*/new WeakMap();
...
var _handleNewPointClick = /*#__PURE__*/new WeakMap();
...
class PointPresenter {
  constructor(pointContainer, changeData, changeMode) {
    ...
    _defineProperty(this, "init", point => {
      ...
      _classPrivateFieldGet(this, _pointEditComponent).setFormSubmitHandler(_classPrivateFieldGet(this, _handleFormSubmit)); // this.#pointComponent.setEditClickHandler(() => {
    ...
    _defineProperty(this, "setViewState", state => {
      ...
      switch (state) {
        ...
        case State.ABORTING:
          _classPrivateFieldGet(this, _pointComponent).shake(resetFormState);

          _classPrivateFieldGet(this, _pointEditComponent).shake(resetFormState);
    ...
    _classPrivateFieldInitSpec(this, _onArrowClick, {
      writable: true,
      value: () => {
        if (_classPrivateFieldGet(this, _point).querySelector('.event__rollup-btn')) {
          _classPrivateFieldGet(this, _replaceFormToPoint).call(this);
        }
      }
    });
    ...
    _classPrivateFieldInitSpec(this, _handleFavorite, {
      writable: true,
      value: () => {
        _classPrivateFieldGet(this, _changeData).call(this, _const__WEBPACK_IMPORTED_MODULE_3__.UserAction.UPDATE_POINT, _const__WEBPACK_IMPORTED_MODULE_3__.UpdateType.PATCH, { ..._classPrivateFieldGet(this, _point),
    ...
    _classPrivateFieldInitSpec(this, _handleFormSubmit, {
      writable: true,
      value: update => {
        const isDatesEqual = (dateA, dateB) => dateA === null && dateB === null || dayjs__WEBPACK_IMPORTED_MODULE_4___default()(dateA).isSame(dateB, 'D');

        const isMinorUpdate = !isDatesEqual(_classPrivateFieldGet(this, _point).startEventDate, update.startEventDate) || !isDatesEqual(_classPrivateFieldGet(this, _point).endEventDate, update.endEventDate);
    ...
    _classPrivateFieldInitSpec(this, _handleNewPointClick, {
      writable: true,
      value: () => {
...
/* harmony import */ var _utils_sort_functions__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../utils/sort-functions */ "./src/utils/sort-functions.js");
...
/* harmony import */ var _view_loading_view__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../view/loading-view */ "./src/view/loading-view.js");
...
var _loadingComponent = /*#__PURE__*/new WeakMap();
...
var _generatePoint = /*#__PURE__*/new WeakMap();

var _handleModeEvent = /*#__PURE__*/new WeakMap();
...
var _renderLoading = /*#__PURE__*/new WeakMap();
...
class TripPresenter {
  constructor(tripContainer, pointsModel, filterModel) {
    ...
    _classPrivateFieldInitSpec(this, _loadingComponent, {
      writable: true,
      value: new _view_loading_view__WEBPACK_IMPORTED_MODULE_9__["default"]()
    });
    ...
    _defineProperty(this, "createNewPoint", callback => {
      const point = _classPrivateFieldGet(this, _generatePoint).call(this);

      const createNewPointData = { ...point,
        isCreatePoint: true
      };
      ...
      _classPrivateFieldGet(this, _pointNewPresenter).init(createNewPointData, callback);
    });

    _defineProperty(this, "destroy", () => {
      _classPrivateFieldGet(this, _clearBoard).call(this, {
        resetRenderedTotalPrice: true,
        resetSortType: true
      });

      (0,_render_js__WEBPACK_IMPORTED_MODULE_3__.remove)(_classPrivateFieldGet(this, _pointListComponent));

      _classPrivateFieldGet(this, _pointsModel).removeObserver(_classPrivateFieldGet(this, _handleModeEvent));

      _classPrivateFieldGet(this, _filterModel).removeObserver(_classPrivateFieldGet(this, _handleModeEvent));
    });

    _classPrivateFieldInitSpec(this, _generatePoint, {
      writable: true,
      value: () => ({
        pointType: 'taxi',
        id: (0,nanoid__WEBPACK_IMPORTED_MODULE_10__.nanoid)(),
        price: 0,
        offers: [],
        destination: {
          name: '',
    ...
    _classPrivateFieldInitSpec(this, _handleModeEvent, {
      writable: true,
      value: (updateType, data) => {
        switch (updateType) {
          case _const__WEBPACK_IMPORTED_MODULE_6__.UpdateType.PATCH:
            _classPrivateFieldGet(this, _pointPresenter).get(data.id).init(data);
          ...
          case _const__WEBPACK_IMPORTED_MODULE_6__.UpdateType.INIT:
            _classPrivateFieldSet(this, _isLoading, false);

            (0,_render_js__WEBPACK_IMPORTED_MODULE_3__.remove)(_classPrivateFieldGet(this, _loadingComponent));
    ...
    _classPrivateFieldInitSpec(this, _handleViewAction, {
      ...
      value: async (actionType, updateType, update) => {
        switch (actionType) {
          case _const__WEBPACK_IMPORTED_MODULE_6__.UserAction.UPDATE_POINT:
            _classPrivateFieldGet(this, _pointPresenter).get(update.id).setViewState(_Point_presenter__WEBPACK_IMPORTED_MODULE_4__.State.SAVING);

            try {
              await _classPrivateFieldGet(this, _pointsModel).updatePoint(updateType, update);
            } catch (err) {
              _classPrivateFieldGet(this, _pointPresenter).get(update.id).setViewState(_Point_presenter__WEBPACK_IMPORTED_MODULE_4__.State.ABORTING);
            }

            break;

          case _const__WEBPACK_IMPORTED_MODULE_6__.UserAction.ADD_POINT:
          ...
          case _const__WEBPACK_IMPORTED_MODULE_6__.UserAction.DELETE_POINT:
            _classPrivateFieldGet(this, _pointPresenter).get(update.id).setViewState(_Point_presenter__WEBPACK_IMPORTED_MODULE_4__.State.DELETING);
    ...
    _classPrivateFieldInitSpec(this, _handleSortTypeChange, {
      ...
      value: sortType => {
        ...
        _classPrivateFieldSet(this, _currentSortType, sortType); // this.#clearPointList();
    ...
    _classPrivateFieldInitSpec(this, _renderPoint, {
      writable: true,
      value: point => {
        const pointPresenter = new _Point_presenter__WEBPACK_IMPORTED_MODULE_4__["default"](_classPrivateFieldGet(this, _pointListComponent), _classPrivateFieldGet(this, _handleViewAction), _classPrivateFieldGet(this, _handleModeChange));
    ...
    _classPrivateFieldInitSpec(this, _renderPoints, {
      writable: true,
      value: points => {
        points.forEach(point => _classPrivateFieldGet(this, _renderPoint).call(this, point));
      }
    });
    ...
    _classPrivateFieldInitSpec(this, _renderSort, {
      writable: true,
      value: () => {
        _classPrivateFieldSet(this, _sortComponent, new _view_sort_view__WEBPACK_IMPORTED_MODULE_0__["default"](_classPrivateFieldGet(this, _currentSortType)));
        ...
        _classPrivateFieldGet(this, _sortComponent).setSortChangeClickHandler(_classPrivateFieldGet(this, _handleSortTypeChange));
      }
    });

    _classPrivateFieldInitSpec(this, _renderLoading, {
      writable: true,
      value: () => {
        (0,_render_js__WEBPACK_IMPORTED_MODULE_3__.render)(_classPrivateFieldGet(this, _pointListComponent), _classPrivateFieldGet(this, _loadingComponent), _render_js__WEBPACK_IMPORTED_MODULE_3__.renderPosition.AFTERBEGIN);
      }
    });
    ...
    _classPrivateFieldInitSpec(this, _clearBoard, {
      writable: true,
      value: ({
        resetRenderedTotalPrice = false,
        resetSortType = false
      } = {}) => {
        const totalPointsPrice = 0; //this.points.price.forEach((sum, price) => sum + price);
        ...
        if (resetRenderedTotalPrice) {
          ...
          _classPrivateFieldSet(this, _renderedTotalPrice, Math.min(totalPointsPrice, _classPrivateFieldGet(this, _renderedTotalPrice)));
        }
    ...
    _classPrivateFieldInitSpec(this, _renderBoard, {
      writable: true,
      value: () => {
        if (_classPrivateFieldGet(this, _isLoading)) {
          _classPrivateFieldGet(this, _renderLoading).call(this);
        ...
        _classPrivateFieldGet(this, _renderPoints).call(this, this.points);
      }
    });
...
/***/ "./src/utils/abstract-observers.js":
/*!*****************************************!*\
  !*** ./src/utils/abstract-observers.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "formatTimeInMinute": () => (/* binding */ formatTimeInMinute)
/* harmony export */ });
const formatTimeInMinute = min => {
  if (min < 60) {
    return `${min}M`;
  } else if (min < 1440) {
    let minutes = min % 60;
...
class LoadingView extends _abstract_view__WEBPACK_IMPORTED_MODULE_0__["default"] {
  get template() {
...
const createPointEditOffersTemplate = (offer, isDisabled) => `<div class="event__offer-selector">
...
const createDestinationPicturesTemplate = picture => `<img class="event__photo" src="${picture.src}" alt="${picture.description}">`;
      ...
      <form class="event event--edit" action="#" method="post">
        <header class="event__header">
          ...
          <div class="event__field-group  event__field-group--time">
            ...
            <input class="event__input  event__input--time" id="event-start-time-1" type="text" name="event-start-time" value="${dayjs__WEBPACK_IMPORTED_MODULE_2___default()(startEventDate).format('DD/MM/YY H:m')}" ${isDisabled ? 'disabled' : ''}>
            &mdash;
            <label class="visually-hidden" for="event-end-time-1">To</label>
            <input class="event__input  event__input--time" id="event-end-time-1" type="text" name="event-end-time" value="${dayjs__WEBPACK_IMPORTED_MODULE_2___default()(endEventDate).format('DD/MM/YY H:m')}" ${isDisabled ? 'disabled' : ''}>
          </div>
...
var _setDatepickerStart = /*#__PURE__*/new WeakMap();

var _setDatepickerEnd = /*#__PURE__*/new WeakMap();

var _startDueDateChangeHander = /*#__PURE__*/new WeakMap();

var _endDueDateChangeHandler = /*#__PURE__*/new WeakMap();
...
class OfferFormView extends _smart_view__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(_point) {
    ...
    _defineProperty(this, "restoreHandlers", () => {
      ...
      _classPrivateFieldGet(this, _setDatepickerStart).call(this);

      _classPrivateFieldGet(this, _setDatepickerEnd).call(this);
    ...
    _classPrivateFieldInitSpec(this, _setDatepickerStart, {
      writable: true,
      value: () => {
        _classPrivateFieldSet(this, _datepicker, (0,flatpickr__WEBPACK_IMPORTED_MODULE_1__["default"])(this.element.querySelector('#event-start-time-1'), {
          dateFormat: 'd/m/y H:i',
          enableTime: true,
          defaultDate: this._data.startEventDate,
          onChange: _classPrivateFieldGet(this, _startDueDateChangeHander)
        }));
      }
    });

    _classPrivateFieldInitSpec(this, _setDatepickerEnd, {
      writable: true,
      value: () => {
        const minDate = this._data.startEventDate;

        _classPrivateFieldSet(this, _datepicker, (0,flatpickr__WEBPACK_IMPORTED_MODULE_1__["default"])(this.element.querySelector('#event-end-time-1'), {
          dateFormat: 'd/m/y H:i',
          enableTime: true,
          minDate: minDate,
          onChange: _classPrivateFieldGet(this, _endDueDateChangeHandler)
        }));
      }
    });

    _classPrivateFieldInitSpec(this, _startDueDateChangeHander, {
      writable: true,
      value: ([userDate]) => {
        this.updateData({
    ...
    _classPrivateFieldInitSpec(this, _endDueDateChangeHandler, {
      writable: true,
      value: ([userDate]) => {
        this.updateData({
          endEventDate: userDate
        });
      }
    });
...
/* harmony import */ var _abstract_view_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./abstract-view.js */ "./src/view/abstract-view.js");
/* harmony import */ var _utils_time_function_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/time-function.js */ "./src/utils/time-function.js");
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
const createPointTemplate = point => {
  ...
  const timeBetweenDateInMin = dayjs__WEBPACK_IMPORTED_MODULE_0___default()(endEventDate).diff(startEventDate, 'minute');
  const formatPeriod = (0,_utils_time_function_js__WEBPACK_IMPORTED_MODULE_2__.formatTimeInMinute)(timeBetweenDateInMin);
  const favoriteClassName = isFavorite ? 'event__favorite-btn event__favorite-btn--active' : 'event__favorite-btn';
  return `<li class="trip-events__item">
        <div class="event">
          <time class="event__date" datetime="${startEventDate}">${dayjs__WEBPACK_IMPORTED_MODULE_0___default()(startEventDate).format('MMM DD')}</time>
          ...
          <div class="event__schedule">
            <p class="event__time">
              <time class="event__start-time" datetime="${startEventDate}">${dayjs__WEBPACK_IMPORTED_MODULE_0___default()(startEventDate).format('HH:mm')}</time>
              &mdash;
              <time class="event__end-time" datetime="${endEventDate}">${dayjs__WEBPACK_IMPORTED_MODULE_0___default()(endEventDate).format('HH:mm')}</time>
            </p>
...
const createSiteMenuTemplate = () => `<div class="trip-controls__navigation">
    ...
    <nav class="trip-controls__trip-tabs  trip-tabs">
      <a class="trip-tabs__btn  trip-tabs__btn--active" href="#" value="${_const_js__WEBPACK_IMPORTED_MODULE_1__.MenuItem.TABLE}">Table</a>
      <a class="trip-tabs__btn" href="#" value="${_const_js__WEBPACK_IMPORTED_MODULE_1__.MenuItem.STATS}">Stats</a>
    </nav>
  </div>
  `;
...
class SiteMenuView extends _abstract_view_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(...args) {
    ...
    _defineProperty(this, "setMenuClickHandler", callback => {
      this._callback.menuClick = callback;
      const links = [...this.element.querySelectorAll('.trip-tabs__btn')];
      links.forEach(link => {
        link.addEventListener('click', _classPrivateFieldGet(this, _menuClickHandler));
      });
    });

    _defineProperty(this, "setMenuItem", menuItem => {
    ...
    _classPrivateFieldInitSpec(this, _menuClickHandler, {
      writable: true,
      value: evt => {
        evt.preventDefault();
...
const CreateSortTemplate = currentSortType => `<form class="trip-events__trip-sort  trip-sort" action="#" method="get">
            <div class="trip-sort__item  trip-sort__item--day">
              <input id="sort-day" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="sort-day" ${currentSortType === _utils_sort_functions_js__WEBPACK_IMPORTED_MODULE_1__.SortType.DAY ? 'checked' : ''}>
            ...
            <div class="trip-sort__item  trip-sort__item--time">
              <input id="sort-time" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="sort-time" data-sort-type="${_utils_sort_functions_js__WEBPACK_IMPORTED_MODULE_1__.SortType.TIME.text}" ${currentSortType === _utils_sort_functions_js__WEBPACK_IMPORTED_MODULE_1__.SortType.TIME ? 'checked' : ''}>
              <label class="trip-sort__btn" for="sort-time">Time</label>
            </div>

            <div class="trip-sort__item  trip-sort__item--price">
              <input id="sort-price" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="sort-price" data-sort-type="${_utils_sort_functions_js__WEBPACK_IMPORTED_MODULE_1__.SortType.PRICE.text}" ${currentSortType === _utils_sort_functions_js__WEBPACK_IMPORTED_MODULE_1__.SortType.PRICE ? 'checked' : ''}>
...
class SortView extends _abstract_view_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(currentSortType) {
    ...
    _defineProperty(this, "setSortChangeClickHandler", callback => {
  ...
  get template() {
    return CreateSortTemplate(_classPrivateFieldGet(this, _currentSortType));
  }
...
/* harmony import */ var _presenter_Filter_presenter__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./presenter/Filter-presenter */ "./src/presenter/Filter-presenter.js");
/* harmony import */ var _const__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./const */ "./src/const.js");
/* harmony import */ var _api_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./api-service */ "./src/api-service.js");
...
const siteMenuComponent = new _view_site_menu_view__WEBPACK_IMPORTED_MODULE_1__["default"]();
const pointsModel = new _model_points_model__WEBPACK_IMPORTED_MODULE_4__["default"](new _api_service__WEBPACK_IMPORTED_MODULE_8__["default"](END_POINT, AUTHORIAZATION));
const filterModel = new _model_filter_model__WEBPACK_IMPORTED_MODULE_5__["default"]();
const tripPresenter = new _presenter_Trip_presenter__WEBPACK_IMPORTED_MODULE_3__["default"](mainContainer, pointsModel, filterModel);
const filterPresenter = new _presenter_Filter_presenter__WEBPACK_IMPORTED_MODULE_6__["default"](siteMenuElement, filterModel);

const handlePointNewFormClose = () => {
  siteMenuComponent.element.querySelector(`[value=${_const__WEBPACK_IMPORTED_MODULE_7__.MenuItem.TABLE}]`).disabled = false;
  siteMenuComponent.element.querySelector(`[value=${_const__WEBPACK_IMPORTED_MODULE_7__.MenuItem.STATS}]`).disabled = false;
  siteMenuComponent.setMenuItem(_const__WEBPACK_IMPORTED_MODULE_7__.MenuItem.TABLE);
};

const handleSiteMenuClick = menuItem => {
  switch (menuItem) {
    case _const__WEBPACK_IMPORTED_MODULE_7__.MenuItem.ADD_NEW_POINT:
      // Скрыть статистику
      ...
      siteMenuComponent.element.querySelector(`[value=${_const__WEBPACK_IMPORTED_MODULE_7__.MenuItem.TABLE}]`).disabled = true;
      siteMenuComponent.element.querySelector(`[value=${_const__WEBPACK_IMPORTED_MODULE_7__.MenuItem.STATS}]`).disabled = true;
      break;

    case _const__WEBPACK_IMPORTED_MODULE_7__.MenuItem.TABLE:
      filterPresenter.init();
      siteMenuComponent.setMenuItem(_const__WEBPACK_IMPORTED_MODULE_7__.MenuItem.TABLE);
      tripPresenter.init(); // Скрыть статистику

      break;

    case _const__WEBPACK_IMPORTED_MODULE_7__.MenuItem.STATS:
      filterPresenter.destroy(); // Скрыть фильтры

      siteMenuComponent.setMenuItem(_const__WEBPACK_IMPORTED_MODULE_7__.MenuItem.STATS);
      tripPresenter.destroy(); // Показать статистику
...
pointsModel.init().finally(() => {
  (0,_render__WEBPACK_IMPORTED_MODULE_2__.render)(siteMenuElement, siteMenuComponent, _render__WEBPACK_IMPORTED_MODULE_2__.renderPosition.AFTERBEGIN);
  (0,_render__WEBPACK_IMPORTED_MODULE_2__.render)(headerMenu, new _view_header_info_view__WEBPACK_IMPORTED_MODULE_0__["default"]().element, _render__WEBPACK_IMPORTED_MODULE_2__.renderPosition.AFTERBEGIN);
