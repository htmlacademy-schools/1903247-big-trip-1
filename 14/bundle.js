...
/* harmony import */ var _view_loading_view__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../view/loading-view */ "./src/view/loading-view.js");
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
class TripPresenter {
  constructor(tripContainer, pointsModel, filterModel) {
    ...
    _classPrivateFieldInitSpec(this, _loadingComponent, {
      writable: true,
      value: new _view_loading_view__WEBPACK_IMPORTED_MODULE_10__["default"]()
    });
    ...
    _defineProperty(this, "createNewPoint", callback => {
      const point = (0,_mock_point__WEBPACK_IMPORTED_MODULE_8__.generatePoint)();
      point.destination = '';
      ...
      <form class="event event--edit" action="#" method="post">
        <header class="event__header">
          ...
          <div class="event__field-group  event__field-group--time">
            ...
            <input class="event__input  event__input--time" id="event-start-time-1" type="text" name="event-start-time" value="${dayjs__WEBPACK_IMPORTED_MODULE_2___default()(startEventDate).format('DD/MM/YY H:m')}">
            &mdash;
            <label class="visually-hidden" for="event-end-time-1">To</label>
            <input class="event__input  event__input--time" id="event-end-time-1" type="text" name="event-end-time" value="${dayjs__WEBPACK_IMPORTED_MODULE_2___default()(endEventDate).format('DD/MM/YY H:m')}">
          </div>
...
_defineProperty(OfferFormView, "parsePointToData", point => ({ ...point //isPointDestination: point.destination !== null,
